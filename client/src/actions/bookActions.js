...
import { SELECT_BOOK_FROM_DB, RETRIEVE_BOOK_FROM_GOODREADS } from './types';

export const selectBookFromDB = bookID => async dispatch => {
  try {
...
export const retrieveBookFromGoodreads = bookID => async dispatch => {
  try {
