    ...
    return (
      <Link to={linkTo} className="swipe-card item">
        ...
        <div className="middle aligned content">
          <div className="header">{this.props.swipe.book.title}</div>
          <div className="description">{this.props.swipe.book.author}</div>

          <div className="extra">
            <div className={`ui right floated icon`}>
              <i
                className={`icon outline huge thumbs ${iconClass} ${iconColor}`}
              />
            </div>
            {/* <span>
