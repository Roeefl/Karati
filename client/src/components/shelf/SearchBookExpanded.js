...
import {
  retrieveBookFromGoodreads,
  resetBookFromGoodreads
} from '../../actions';
...
class SearchBookExpanded extends React.Component {
  componentDidMount() {
    if (
      this.props.selectedBookFromSearch &&
      this.props.goodreadsID &&
      this.props.goodreadsID !== this.props.selectedBookFromSearch.goodreadsID
    ) {
