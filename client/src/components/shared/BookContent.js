...
class BookContent extends React.Component {
  render() {
    if (this.props.book === false) {
      return <Spinner message="Fetching Book Data..." />;
    }

    if (!this.props.book || !this.props.book.title) {
      return <Message color="red" lines={['Error in book component']} />;
    }

    const genres = this.props.book.genres.map(genre => {
      return (
        <div
          className="ui blue icon label book-genre"
        ...
        <div className="ui left aligned eight wide column grid">
          ...
          <div className="left aligned ten wide column">
            <div className="content">
              ...
              <div className="meta author">{this.props.book.author}</div>
            </div>
          </div>
        </div>
        ...
        <div className="two column row">
              ...
              <div className="description ui segment">
                <div
                  dangerouslySetInnerHTML={{
                    __html: this.props.book.description
                  }}
                />
              </div>
            </div>
          ...
          <div className="column">
            <div className="ui book-anecdote">
              <i className="ui bookmark outline icon" />{' '}
              {this.props.book.numOfPages} Pages
            </div>
            <div className="ui book-anecdote">
              <i className="ui bookmark outline icon" /> Published On:{' '}
              {this.props.book.publicationYear}
            </div>
            <div className="ui book-anecdote">
              <i className="ui bookmark up outline icon" /> Average Rating:{' '}
