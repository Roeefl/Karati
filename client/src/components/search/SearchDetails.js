...
class SearchDetails extends React.Component {
  ...
  addToMyShelf = async () => {
    ...
    try {
      const res = await Axios.post('/api/myShelf', {
        goodreadsID: this.props.selectedBook.id._
      });
      console.log(res);
      ...
      this.setState({
        addBookComponentType: res.data.bookAddedToMyShelf ? 3 : 4
      }); // Successfully added / already own
      ...
      default:
        return (
          <div className="ui negative message">
            <div className="header">You already own this book.</div>
            <p>Go to {this.renderMyShelfLink()} to see all your books.</p>
          </div>
        );
    }
  ...
  renderContent() {
        ...
        <div className="book-info ui card">
          <div className="image dimmable">
            ...
            <img
              ...
              alt={this.props.selectedBook.desc}
            />
          </div>
          <div className="content">
            <div className="header">{this.props.selectedBook.title}</div>
            <div className="meta">{this.props.selectedBook.author.name}</div>
    ...
    return <div className="book-info ui card"></div>;
  }
